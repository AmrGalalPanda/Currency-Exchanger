...
describe('ConverterComponent', () => {
    ...
    it(
        'should have a header which says `Enter The number that you want to convert and Currency`',
        waitForAsync(() => {
            hElement = fixture.debugElement.query(By.css('h1')).nativeElement;

            expect(hElement.innerText).toEqual('Enter The number that you want to convert and Currency');
        }),
    );
